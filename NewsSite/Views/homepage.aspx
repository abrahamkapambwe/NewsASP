                            ...
                            <div style="clear: both; margin-right: 10px; height: 200px; margin-bottom: 5px; margin-top: 5px">
                                <div class="viewport">
                                    <asp:Image  ID="imgPhoto" style="margin-bottom: 20px"  alt='<%#Eval("NewsHeadline") %>'
                                        width="100%" height="100%" title='<%#Eval("NewsHeadline") %>'  runat="server"/>
                                </div>
                                <div class="information-design">
                                    <div class="template-name">
                                        <span><asp:HyperLink runat="server"  ID="hyperNavi" class="brand type-of-story">
                ...
                <div class="information-design">
                    <div class="template-information">
                        <asp:ListView runat="server" ID="lstPoliticsHeadline" OnItemDataBound="lstPoliticsHeadline_itemDatabound">
                            ...
                            <ItemTemplate>
                                <div>
                                    <span><span class="smaller"></span><asp:HyperLink runat="server"  ID="hyperNavi">
                                        <%#Eval("NewsHeadline")%> </asp:HyperLink><br />
                                    </span>
                                </div>
                            </ItemTemplate>
                        </asp:ListView>
                        <span><span class="smaller"></span><a href="">More from newsSA »</a> </span>
                    </div>
                    <div class="clear">
                    </div>
                    <div class="clear">
                ...
                <div class="information-design">
                    <div class="template-information">
                        <asp:ListView runat="server" ID="lstBusinessHeadline" OnItemDataBound="lstBusinessHeadline_itemDatabound">
                            ...
                            <ItemTemplate>
                                <div>
                                    <span><span class="smaller"></span><span><asp:HyperLink runat="server"  ID="hyperNavi">
                                        <%#Eval("NewsHeadline")%> </asp:HyperLink><br />
                                    </span>
                                </div>
                            </ItemTemplate>
                        </asp:ListView>
                        <span><span class="smaller"></span><a href="">More from NewsSouthAfrica »</a> </span>
                    </div>
                    <div class="clear">
                    </div>
                    <div class="clear">
